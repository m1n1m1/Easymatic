 ...
 * light, send mail, ask the user a question or reach any other Easymatic facade —
 ...
 *
 * That is not as restrictive as it sounds. Easymatic's own nodes are given no more
 ...
 * [io.github.m1n1m1.easymatic.nodeapi.wire.ExecOutputsWire.Named]. A route the declaration
