 ...
 *
 * Easymatic offers a button to this from the Plugins screen, having found it by resolving
 * `io.github.m1n1m1.easymatic.action.PLUGIN_SETTINGS` against **this package** through
 ...
 *
 * Note what this file needs from Easymatic: **nothing**. No SDK class, no theme, no
