...
import io.github.m1n1m1.easymatic.plugin.PluginChoiceRequest
import io.github.m1n1m1.easymatic.plugin.finishWithChoice
import io.github.m1n1m1.easymatic.plugin.finishWithoutChoosing

/**
 * The plugin's own chooser — what `@PluginChoice(chooser = SCREEN)` opens.
 *
 * Easymatic resolves this Activity against **this** package through `PackageManager`,
 * having found `io.github.m1n1m1.easymatic.action.PLUGIN_CHOICE` in the manifest, and starts it
 ...
 * ## What it is not
 *
 * Not a way into Easymatic. This Activity gets [PluginChoiceRequest]'s three strings and
 ...
 *
 * Note also what it needs from Easymatic to be written: two constants and two extension
