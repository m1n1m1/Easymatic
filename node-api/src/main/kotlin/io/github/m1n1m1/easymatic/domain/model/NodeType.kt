 ...
 * [io.github.m1n1m1.easymatic.engine.WorkflowExecutor]). They differ only in where
 ...
 * [Item][io.github.m1n1m1.easymatic.domain.model.schema.Item] whose shape is
 ...
 * [io.github.m1n1m1.easymatic.domain.registry.effectivePorts] instead of reading
 * [ports] directly.
 */
