 ...
 * [io.github.m1n1m1.easymatic.domain.model.WorkflowNode.config].
 *
...
sealed interface ConfigFieldType<out T> {
     ...
     * [io.github.m1n1m1.easymatic.domain.model.schema.DateTime.parse], which also accepts
     ...
     * [io.github.m1n1m1.easymatic.domain.model.PhoneRef] spec, and its commonest form
     ...
     * [io.github.m1n1m1.easymatic.domain.model.TimeOfDay].
     */
     ...
     * [io.github.m1n1m1.easymatic.domain.model.PortSpec]).
     *
     ...
     * [io.github.m1n1m1.easymatic.domain.model.ToolOverrides]).
     *
     ...
     * [io.github.m1n1m1.easymatic.domain.model.config.ChoiceChooser].
     *
 ...
 * [io.github.m1n1m1.easymatic.domain.model.WorkflowNode.config], [label] is shown to
 ...
 * [io.github.m1n1m1.easymatic.domain.model.config.VisibleWhen] and applied by
...
data class ConfigField<T>(
     ...
     * field whose name already says it. See [io.github.m1n1m1.easymatic.domain.model.config.Hint] for
