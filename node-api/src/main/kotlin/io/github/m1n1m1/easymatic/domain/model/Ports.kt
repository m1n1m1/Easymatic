 ...
 * ([io.github.m1n1m1.easymatic.engine.ActionNodeDefinition] and
 * [io.github.m1n1m1.easymatic.engine.TriggerNodeDefinition]).
 *
 * DATA *input* ports are not declared here: they are derived from the `@Wired`
 * properties of a node's config class (see
 * [io.github.m1n1m1.easymatic.domain.registry.NodeSchema]). What remains is the
 ...
 * [io.github.m1n1m1.easymatic.engine.ExecutionRoute] and the design-time port
 * resolution in [io.github.m1n1m1.easymatic.domain.registry.effectivePorts] cannot
...
object ExecPorts {
    ...
    /** A loop's per-iteration pulse. See [io.github.m1n1m1.easymatic.engine.LoopAction]. */
     ...
     * See [io.github.m1n1m1.easymatic.engine.ForkAction].
     */
 ...
 * [io.github.m1n1m1.easymatic.domain.registry.effectivePorts]. Ordinary nodes derive
