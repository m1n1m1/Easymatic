...
import io.github.m1n1m1.easymatic.domain.model.schema.jsonElementToValue
 ...
 * Easymatic's own grants — `READ_CONTACTS`, `SEND_SMS`, `CALL_PHONE`,
 ...
 * plugin could fire as Easymatic. A plugin does what its own manifest permits and
