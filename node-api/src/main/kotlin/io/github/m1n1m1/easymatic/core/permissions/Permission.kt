...
/**
 * Catalogue of permissions used across Easymatic. Centralised here so the
...
object Permissions {
     ...
     * caller's number rides on `READ_CALL_LOG`, which Easymatic deliberately does not
     ...
     * Easymatic lists the calendars itself — which needs this grant before the config
     ...
     * declaration.
     *
     * The second reason is stranger and outlives the first. Easymatic also declares `CAMERA`
