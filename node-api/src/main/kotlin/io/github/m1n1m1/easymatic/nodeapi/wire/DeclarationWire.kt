 ...
 * rather than two: an `IEasymaticPlugin.protocolVersion()` transaction existed until
 ...
 *
 * Every refusal above has the same shape: the field would reach something *Easymatic keeps*
...
data class NodeDeclarationWire(
     ...
     * never against Easymatic — and surfaced as a warning that blocks nothing.
