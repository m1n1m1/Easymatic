 ...
 * [io.github.m1n1m1.easymatic.domain.model.Workflow]. The persisted graph refers to
 * nodes by `typeId` and ports by name; the schema for a port is reconstructed
 * from the [io.github.m1n1m1.easymatic.domain.registry.NodeTypeRegistry] /
 * [io.github.m1n1m1.easymatic.domain.registry.ActionRegistry] at load time.
 *
