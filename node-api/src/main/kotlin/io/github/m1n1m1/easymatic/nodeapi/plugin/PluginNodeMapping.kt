...
import io.github.m1n1m1.easymatic.domain.registry.VisibilityRule
import io.github.m1n1m1.easymatic.nodeapi.wire.ConfigFieldTypeWire
import io.github.m1n1m1.easymatic.nodeapi.wire.ConfigFieldWire
...
import io.github.m1n1m1.easymatic.nodeapi.wire.resolvedIcon
import io.github.m1n1m1.easymatic.nodeapi.wire.resolvedIntentIcon
import io.github.m1n1m1.easymatic.nodeapi.wire.toItemSchema
 ...
 * [io.github.m1n1m1.easymatic.domain.registry.NodeDeclarationRules] about it, which would
...
internal object PluginNodeMapping {
    ...
    fun toDefinition(declaration: NodeDeclarationWire): NodeTypeDefinition = NodeTypeDefinition(
        ...
        // declaring one would have Easymatic badge a node in the user's macro on the
