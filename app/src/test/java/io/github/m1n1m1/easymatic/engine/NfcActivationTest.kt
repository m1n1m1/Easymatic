...
import io.github.m1n1m1.easymatic.engine.trigger.NfcTagConfig
...
class NfcActivationTest {
    ...
    fun `a phone that can never deliver a tap says so`() = runBlocking {
        ...
        assertTrue(blockedWarning.message, blockedWarning.message.contains("switched off for Easymatic"))
    }
