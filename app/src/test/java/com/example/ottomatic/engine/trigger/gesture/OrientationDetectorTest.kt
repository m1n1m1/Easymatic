...
import com.example.ottomatic.engine.trigger.gesture.SampleRun.Position
...
class OrientationDetectorTest {
     ...
     *
     * [com.example.ottomatic.data.sensor.SensorBridge] shares a single
     ...
     * [com.example.ottomatic.engine.trigger.SensorSample.elapsedMs], that would
