...
class NodeStringsSyncTest {
    ...
    fun `generated files match the declarations`() {
        if (System.getProperty("ottomatic.i18n.regenerate") == "true") {
    ...
    private companion object {
        ...
        val IDS = File("src/main/java/com/example/ottomatic/feature/i18n/NodeStringIds.kt")
...
private fun toIdsKt(entries: List<StringEntry>): String = buildString {
    ...
    appendLine()
    appendLine("package com.example.ottomatic.feature.i18n")
    appendLine()
    appendLine("import com.example.ottomatic.R")
    appendLine()
