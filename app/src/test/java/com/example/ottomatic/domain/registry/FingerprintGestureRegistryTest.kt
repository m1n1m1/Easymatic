...
class FingerprintGestureRegistryTest {
    ...
    fun `the payload contract matches the service that emits it` () {
        ...
        assertEquals(
            OttomaticAccessibilityService.FINGERPRINT_TRIGGER_TYPE,
            FingerprintGestureTrigger.TRIGGER_TYPE,
        )
        assertEquals(
            OttomaticAccessibilityService.KEY_TRIGGER_TYPE,
            FingerprintGestureTrigger.KEY_TRIGGER_TYPE,
        )
        assertEquals(OttomaticAccessibilityService.KEY_GESTURE, FingerprintGestureTrigger.KEY_GESTURE)
        assertEquals(
            listOf(
                OttomaticAccessibilityService.GESTURE_SWIPE_UP,
                OttomaticAccessibilityService.GESTURE_SWIPE_DOWN,
                OttomaticAccessibilityService.GESTURE_SWIPE_LEFT,
                OttomaticAccessibilityService.GESTURE_SWIPE_RIGHT,
            ),
