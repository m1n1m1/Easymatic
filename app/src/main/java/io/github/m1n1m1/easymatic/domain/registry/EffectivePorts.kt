...
import io.github.m1n1m1.easymatic.domain.model.ANY_LIST
import io.github.m1n1m1.easymatic.domain.model.ANY_STRUCT
...
/** The config key holding a script's input ports (a list of [io.github.m1n1m1.easymatic.domain.model.PortSpec]). */
val SCRIPT_INPUTS_KEY = ConfigKey("inputs")

/** The config key holding a script's output ports (a list of [io.github.m1n1m1.easymatic.domain.model.PortSpec]). */
 ...
 * [io.github.m1n1m1.easymatic.engine.evaluateCompare] (as what a blank literal
 ...
 * are declared statically on [io.github.m1n1m1.easymatic.engine.ExecOutputs.DECISION],
