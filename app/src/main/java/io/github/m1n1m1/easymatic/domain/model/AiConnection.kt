...
enum class AiProvider {
     ...
     * wire at all. That is why [io.github.m1n1m1.easymatic.data.ai.protocolFor] answers
     * **null** for it rather than an [io.github.m1n1m1.easymatic.data.ai.AiProtocol], and why
...
data class AiModelProfile(
     ...
     * [io.github.m1n1m1.easymatic.core.service.AiRequest.DEFAULT_MAX_OUTPUT_TOKENS].
     */
