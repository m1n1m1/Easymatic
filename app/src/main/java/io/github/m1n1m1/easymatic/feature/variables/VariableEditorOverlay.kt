 ...
 * [io.github.m1n1m1.easymatic.feature.geofence.GeofenceDraft]. That one needs a
...
private val NAME_KEY = io.github.m1n1m1.easymatic.core.model.ConfigKey("name")
private val TYPE_KEY = io.github.m1n1m1.easymatic.core.model.ConfigKey("type")
private val VALUE_KEY = io.github.m1n1m1.easymatic.core.model.ConfigKey("initialValue")
private val NOTE_KEY = io.github.m1n1m1.easymatic.core.model.ConfigKey("description")
