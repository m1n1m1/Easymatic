...
import io.github.m1n1m1.easymatic.domain.registry.TransformRegistry
import io.github.m1n1m1.easymatic.domain.registry.ValueRegistry
import io.github.m1n1m1.easymatic.engine.plugin.PluginNodeRunner
 ...
 * [io.github.m1n1m1.easymatic.domain.model.DataConnection] into the target and reads
 ...
 *
 * A data edge whose source is a [io.github.m1n1m1.easymatic.engine.ValueNode] or an
...
class WorkflowExecutor(
    ...
    private fun blockedReason(
        run: Run,
        connection: io.github.m1n1m1.easymatic.domain.model.ExecConnection,
        from: WorkflowNode,
        target: WorkflowNode,
    ): String? = when {
     ...
     * [PluginDeclarationValidator][io.github.m1n1m1.easymatic.nodeapi.plugin.PluginDeclarationValidator]
     ...
     * following each [io.github.m1n1m1.easymatic.domain.model.DataConnection] into
