...
import io.github.m1n1m1.easymatic.engine.trigger.keys.KeyGestureDetector
import io.github.m1n1m1.easymatic.engine.trigger.keys.KeyLongPressDetector
import io.github.m1n1m1.easymatic.engine.trigger.keys.KeyPress
import io.github.m1n1m1.easymatic.engine.trigger.keys.KeyPressDetector
import io.github.m1n1m1.easymatic.engine.trigger.keys.KeySequenceDetector
            ...
            .map { press ->
                NodeOutput(
                    SystemState(
                        ...
                        timestamp = io.github.m1n1m1.easymatic.domain.model.schema.DateTime(
