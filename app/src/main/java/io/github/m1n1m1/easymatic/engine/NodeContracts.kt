...
enum class ExecOutputs(val routes: List<ExecutionRoute>) {
     ...
     * [io.github.m1n1m1.easymatic.engine.validation.GraphValidator] needs no exception.
     * See [LoopAction].
     */
     ...
     * neither [io.github.m1n1m1.easymatic.engine.validation.GraphValidator]'s cycle
     ...
     * is identical, so
     * [io.github.m1n1m1.easymatic.engine.validation.GraphValidator]'s `isFork()` finds one
     * of these by the `resumed` port it already looks for, and
     * [io.github.m1n1m1.easymatic.engine.WorkflowExecutor] pulses it through the same
 ...
 * permission not granted), mirroring [io.github.m1n1m1.easymatic.core.service.DeviceState].
 ...
 * [io.github.m1n1m1.easymatic.engine.WorkflowExecutor]). Like a value node it has no
 ...
 * ([io.github.m1n1m1.easymatic.domain.registry.effectivePorts]), so they emit a
 ...
 * [io.github.m1n1m1.easymatic.engine.validation.GraphValidator]'s cycle rule nor the
...
interface LoopAction<C : Any> : ExecutableAction {
    ...
    /**
     * Never reached: [io.github.m1n1m1.easymatic.engine.WorkflowExecutor] tests for
 ...
 * [io.github.m1n1m1.easymatic.engine.WorkflowExecutor.runFork] does the rest.
