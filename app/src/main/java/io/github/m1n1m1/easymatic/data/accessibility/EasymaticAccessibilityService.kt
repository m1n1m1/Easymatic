 ...
 * [io.github.m1n1m1.easymatic.core.permissions.PrerequisiteType.ACCESSIBILITY_SERVICE]
 ...
 */
class EasymaticAccessibilityService : AccessibilityService() {
    ...
    companion object {
         ...
         */
        @Volatile
        var instance: EasymaticAccessibilityService? = null
            private set
