 ...
 * [io.github.m1n1m1.easymatic.data.trigger.BatteryLevelWorker] via the host when
 ...
 */
internal fun io.github.m1n1m1.easymatic.core.trigger.TriggerEvent.toBatteryState(): BatteryState = BatteryState(
