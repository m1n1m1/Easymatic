...
/**
 * How Easymatic obtains Android's permission to change a picture another app saved.
 *
 * **Four rungs, and which one applies is decided by the API level and by who owns the
 * row**, not by anything the user configured:
 *
 * - **Easymatic's own pictures skip all of it.** A row this app inserted is writable and
...
object MediaConsents {
    ...
    const val CONSENT_ACTIVITY_CLASS: String =
        "io.github.m1n1m1.easymatic.feature.images.MediaConsentActivity"

    const val EXTRA_REQUEST_ID: String = "io.github.m1n1m1.easymatic.media.REQUEST_ID"
