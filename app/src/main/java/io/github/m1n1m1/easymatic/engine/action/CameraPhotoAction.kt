 ...
 *
 * **Blank folder means `DCIM/Easymatic`**, resolved in the data layer rather than here, on
 ...
 *
 * **Headless, through camera2.** Easymatic opens the camera itself: no camera app, no
 ...
 *
 * **`trigger.image_saved` will fire on these**, because a photo in `DCIM/Easymatic` is a new
