...
import io.github.m1n1m1.easymatic.plugin.PLUGIN_CHOICE_ACTION
 ...
 * package and never of Easymatic's.
 *
...
class PluginPackages(private val context: Context) {
    ...
    fun discover(): List<DiscoveredPackage> {
        ...
        return resolved.mapNotNull { info ->
            ...
            // Easymatic itself would resolve here if it ever exported one; an app
     ...
     *
     * Asked of the plugin's uid and never of Easymatic's, which is the whole point: a
     ...
     * own sign-in unreachable from Easymatic, which is not the same thing as refusing it.
     * A plugin that needs a login declares an Activity under [PLUGIN_SETTINGS_ACTION] and
     * Easymatic offers a button to it.
     *
