...
import io.github.m1n1m1.easymatic.engine.trigger.ImageEventCodec
import io.github.m1n1m1.easymatic.engine.trigger.ImageWatchKind
...
class ImageWatchers(
    ...
    private fun register(onReport: (String, LogLevel) -> Unit) {
        ...
        if (!registered) {
            ...
            onReport(
                "Easymatic does not have access to your photos, so new pictures cannot be noticed",
                LogLevel.WARN,
            )
            return
        }
