...
import io.github.m1n1m1.easymatic.engine.PULSE_ONLY
...
import io.github.m1n1m1.easymatic.engine.trigger.ApiTrigger
import io.github.m1n1m1.easymatic.engine.trigger.encodeToString
import io.github.m1n1m1.easymatic.engine.trigger.toTriggerEventWire
import io.github.m1n1m1.easymatic.engine.trigger.triggerOutputFrom
...
object ApiRun {
     ...
     * door fares better (Easymatic's own process is already up to serve the call),
    ...
    fun start(context: Context, target: ApiTriggerTarget, data: Map<PortName, Item>, caller: String) {
        ...
        try {
            ...
            Log.w("Easymatic", "Could not start the engine for an API run; running in-process", e)
     ...
     * [STATUS_DISABLED][io.github.m1n1m1.easymatic.domain.model.ApiContract.STATUS_DISABLED]
