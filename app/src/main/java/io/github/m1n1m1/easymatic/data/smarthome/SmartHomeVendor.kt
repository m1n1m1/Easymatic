...
/**
 * One vendor's half of [io.github.m1n1m1.easymatic.core.service.SmartHome].
 *
...
internal interface SmartHomeVendor {
     ...
     * next.
     *
     * On the vendor rather than in [io.github.m1n1m1.easymatic.core.service.SmartHomeLimits]
