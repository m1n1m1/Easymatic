...
object PluginTriggerBridge {
    ...
    fun isPluginTrigger(node: WorkflowNode): Boolean =
        PluginNodes.byId(node.typeId)?.definition?.kind == io.github.m1n1m1.easymatic.domain.model.NodeKind.TRIGGER
     ...
     * [io.github.m1n1m1.easymatic.engine.trigger.triggerOutputFrom] — both start a run
