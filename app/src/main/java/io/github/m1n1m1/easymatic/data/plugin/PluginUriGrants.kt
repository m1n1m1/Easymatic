 ...
 * arriving with `FLAG_GRANT_READ_URI_PERMISSION` on it, borrowing Easymatic's own grants.
 ...
 * a URI Easymatic itself has no grant on throws, and the plugin is left exactly as unable
