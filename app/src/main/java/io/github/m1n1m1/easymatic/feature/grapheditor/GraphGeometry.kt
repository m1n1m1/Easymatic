...
object GraphGeometry {
    ...
    fun portOffset(definition: NodeTypeDefinition, port: Port): Offset {
        val isOutput = port.direction == io.github.m1n1m1.easymatic.domain.model.Direction.OUT
    ...
    private fun portOffsetIn(list: List<Port>, port: Port, width: Float): Offset {
        ...
        val y = if (port.direction == io.github.m1n1m1.easymatic.domain.model.Direction.OUT) NODE_HEIGHT else 0f
        return Offset(x, y)
    }
