 ...
 * `io.github.m1n1m1.easymatic.domain.model.CalendarRef` or `CalendarEventRef` and fails
 * closed — [Files]' rule, which is
 * [TimeOfDay][io.github.m1n1m1.easymatic.domain.model.TimeOfDay]'s rule: one reading of the
...
interface Calendars {
     ...
     * [CalendarBusy][io.github.m1n1m1.easymatic.domain.model.CalendarBusy], where that
 ...
 * [DateTime][io.github.m1n1m1.easymatic.domain.model.schema.DateTime].
 */
