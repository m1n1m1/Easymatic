 ...
 * a running [io.github.m1n1m1.easymatic.engine.service.MacroEngineService] may
...
interface ExecutionContext {
     ...
     * same [io.github.m1n1m1.easymatic.core.service.ScriptOutcome.Unavailable] a
     ...
     * see the same [io.github.m1n1m1.easymatic.core.service.PromptAnswer.Unavailable]
     ...
     * posts Easymatic's own, over no permission the user has to hunt for. They address
     * different things too — a tag this app chose, against a
     * [io.github.m1n1m1.easymatic.domain.model.ConversationRef] somebody else's app minted —
 ...
 *
 * It runs *after* [io.github.m1n1m1.easymatic.domain.registry.NodeSchema.decode] has
