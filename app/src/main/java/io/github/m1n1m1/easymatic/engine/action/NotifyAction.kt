...
import io.github.m1n1m1.easymatic.domain.registry.NOTIFY_BUTTON_OUT
import io.github.m1n1m1.easymatic.domain.registry.NOTIFY_INDEX_OUT
import io.github.m1n1m1.easymatic.domain.registry.NOTIFY_REPLY_OUT
import io.github.m1n1m1.easymatic.domain.registry.NOTIFY_TAG_OUT
 ...
 * [io.github.m1n1m1.easymatic.engine.WorkflowExecutor.awaitAndPulse] already handles by
...
class NotifyAction : ForkAction<NotifyConfig> {
     ...
     *
     * Reached only from an AI tool call — [io.github.m1n1m1.easymatic.engine.WorkflowExecutor]
