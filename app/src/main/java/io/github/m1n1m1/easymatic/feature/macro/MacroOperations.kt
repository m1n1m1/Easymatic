...
import io.github.m1n1m1.easymatic.feature.widget.RunTilePin
import io.github.m1n1m1.easymatic.feature.workflowlist.MacroSharing
...
class MacroOperations(
     ...
     *
     * Delegated rather than reimplemented here: the sanitising and the `.easy.json`
