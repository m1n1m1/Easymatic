...
import io.github.m1n1m1.easymatic.domain.transfer.BundledLibrary
import io.github.m1n1m1.easymatic.domain.transfer.ImportResult
import io.github.m1n1m1.easymatic.domain.transfer.MACRO_EXPORT_FORMAT
import io.github.m1n1m1.easymatic.domain.transfer.MacroExport
import io.github.m1n1m1.easymatic.domain.transfer.Requirements
import io.github.m1n1m1.easymatic.domain.transfer.exportOf
import io.github.m1n1m1.easymatic.domain.transfer.importOf
import io.github.m1n1m1.easymatic.domain.transfer.referencedIds
...
class MacroTransferRepository(
     ...
     * here would turn "not an Easymatic file" into a half-decoded macro.
     */
    ...
    private companion object {
        /**
         * `.easy.json` rather than a bare `.easy`: the second extension is what makes
         ...
         */
        const val FILE_SUFFIX = ".easy.json"
