...
import io.github.m1n1m1.easymatic.core.service.MacroRunResult
...
import io.github.m1n1m1.easymatic.engine.api.apiTriggersIn
 ...
 * [io.github.m1n1m1.easymatic.engine.api.ApiRun] uses — because their caller needs an
...
class AndroidMacroControl(
     ...
     *
     * A file read per macro, on [io.github.m1n1m1.easymatic.engine.api.listApiTriggers]'
     ...
     * on [io.github.m1n1m1.easymatic.engine.api.ApiRun.runApiTrigger]'s reasoning: the list
