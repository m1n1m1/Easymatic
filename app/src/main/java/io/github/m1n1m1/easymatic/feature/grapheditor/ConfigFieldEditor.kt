...
import io.github.m1n1m1.easymatic.feature.translate.TranslateLanguagePickerField
import io.github.m1n1m1.easymatic.feature.plugins.PluginChoiceOverlay
...
import io.github.m1n1m1.easymatic.plugin.EXTRA_CONFIG
import io.github.m1n1m1.easymatic.plugin.EXTRA_SOURCE
import io.github.m1n1m1.easymatic.plugin.EXTRA_TYPE_ID
import io.github.m1n1m1.easymatic.plugin.EXTRA_VALUE
...
import io.github.m1n1m1.easymatic.domain.model.TimeOfDay
...
import io.github.m1n1m1.easymatic.feature.api.ApiTokenField
import io.github.m1n1m1.easymatic.feature.apps.AppPickerField
import io.github.m1n1m1.easymatic.feature.calendar.CalendarPickerField
import io.github.m1n1m1.easymatic.feature.contacts.ContactNameField
import io.github.m1n1m1.easymatic.feature.files.FilePathField
import io.github.m1n1m1.easymatic.feature.intent.IntentChoiceField
import io.github.m1n1m1.easymatic.feature.contacts.PhoneNumberField
import io.github.m1n1m1.easymatic.feature.geofence.GeofencePlacePickerOverlay
import io.github.m1n1m1.easymatic.feature.geofence.LocalGeofencePlaces
...
import io.github.m1n1m1.easymatic.feature.ai.ToolOverrideField
import io.github.m1n1m1.easymatic.feature.mail.LocalMailAccounts
import io.github.m1n1m1.easymatic.feature.mail.MailAccountPickerOverlay
import io.github.m1n1m1.easymatic.feature.nfc.LocalNfcTags
import io.github.m1n1m1.easymatic.feature.nfc.NfcTagPickerOverlay
...
import io.github.m1n1m1.easymatic.domain.model.haScopeOf
import io.github.m1n1m1.easymatic.feature.smarthome.HaPickerMode
import io.github.m1n1m1.easymatic.feature.smarthome.mqtt.MqttBrokerPickerOverlay
import io.github.m1n1m1.easymatic.feature.smarthome.HaPickerOverlay
import io.github.m1n1m1.easymatic.feature.smarthome.LightTargetPickerOverlay
import io.github.m1n1m1.easymatic.feature.smarthome.LocalSmartHome
import io.github.m1n1m1.easymatic.feature.sound.SoundPickerField
import io.github.m1n1m1.easymatic.feature.variables.LocalVariables
import io.github.m1n1m1.easymatic.feature.variables.VariablePickerOverlay
import io.github.m1n1m1.easymatic.feature.variables.VariableScope
import io.github.m1n1m1.easymatic.feature.variables.resolve
import io.github.m1n1m1.easymatic.feature.wifi.WifiNetworkField
import io.github.m1n1m1.easymatic.feature.workflowlist.LocalMacros
import io.github.m1n1m1.easymatic.feature.workflowlist.MacroPickerOverlay
    ...
    Column {
        when (type) {
            ...
            ConfigFieldType.FILE_PATH -> {
                // The chooser here does two things at once: it takes the persistable
 ...
 * own screen from being a way back into Easymatic. The `runCatching` is not defensive
