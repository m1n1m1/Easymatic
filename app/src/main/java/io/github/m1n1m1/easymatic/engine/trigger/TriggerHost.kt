...
interface TriggerHost {
    ...
    fun busEvents(): Flow<io.github.m1n1m1.easymatic.core.trigger.TriggerEvent> = TriggerBus.events
     ...
     * the [io.github.m1n1m1.easymatic.engine.ExecutionContext].
     */
     ...
     * [io.github.m1n1m1.easymatic.engine.WorkflowRunner.run] starts) and when a
     ...
     * [io.github.m1n1m1.easymatic.core.service.HubLink] for why — so arming is only a row in
