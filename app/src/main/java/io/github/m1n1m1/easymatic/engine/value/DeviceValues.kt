...
/**
 * The device readers, one value node per [io.github.m1n1m1.easymatic.core.service.DeviceState]
 * member.
 *
 ...
 * behind [io.github.m1n1m1.easymatic.core.service.DeviceState.isTorchOn] rather than
 * this node tracking what Easymatic itself did.
 *
