...
class GeofenceReceiver : BroadcastReceiver() {
     ...
     *
     * A receiver lives in `data/`, has no [io.github.m1n1m1.easymatic.engine.ExecutionContext],
    ...
    companion object {
        ...
        const val ACTION_GEOFENCE_TRANSITION = "io.github.m1n1m1.easymatic.GEOFENCE_TRANSITION"

        /** The app's own away alarm, not a Play Services broadcast. */
        const val ACTION_GEOFENCE_AWAY = "io.github.m1n1m1.easymatic.GEOFENCE_AWAY"
