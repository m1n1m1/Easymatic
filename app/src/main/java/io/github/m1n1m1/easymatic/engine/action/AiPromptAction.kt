...
import io.github.m1n1m1.easymatic.engine.ai.NodeTool
import io.github.m1n1m1.easymatic.engine.ai.NodeToolCatalog
import io.github.m1n1m1.easymatic.engine.ai.NodeToolRunner
 ...
 * [io.github.m1n1m1.easymatic.domain.model.AiModelProfile] — which carries the model, the
 ...
 * published model id, for the reason [io.github.m1n1m1.easymatic.core.service.AiModel]'s
 ...
 *
 * **With [AiPromptConfig.useTools] on, this is the node that makes Easymatic a
...
class AiPromptAction : Action<AiPromptConfig, String> {
     ...
     * library as text through [io.github.m1n1m1.easymatic.core.service.Ai.toolsFor], which
