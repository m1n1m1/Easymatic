 ...
 * notification in [com.example.ottomatic.engine.service.MacroEngineService],
...
object BootFailureNotifier {
    ...
    private const val CHANNEL_ID = "ottomatic.boot_failure"
    ...
    fun notify(context: Context) {
        ...
        val notification = Notification.Builder(app, CHANNEL_ID)
            ...
            .setContentTitle("Ottomatic macros paused")
