 ...
 *
 * **Optimistic pattern**: [com.example.ottomatic.data.trigger.BootReceiver] marks
 ...
 * [com.example.ottomatic.MainActivity].
 *
...
object BootFailureStore {
    ...
    private const val PREFS = "ottomatic.boot_failure"
