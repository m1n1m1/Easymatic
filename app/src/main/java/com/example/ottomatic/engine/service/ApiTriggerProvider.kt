...
import com.example.ottomatic.engine.api.ApiTriggerTarget
...
import com.example.ottomatic.feature.api.ApiConsentActivity
 ...
 *
 * ```
 * val out = contentResolver.call("content://com.example.ottomatic.triggers".toUri(),
