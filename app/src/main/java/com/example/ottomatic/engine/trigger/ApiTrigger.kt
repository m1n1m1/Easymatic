...
import com.example.ottomatic.engine.adaptiveTriggerNode
 ...
 * [com.example.ottomatic.domain.registry.effectivePorts] reads the raw config and
 ...
 * refused ([com.example.ottomatic.domain.model.ApiContract.STATUS_DISABLED]), which
...
class ApiTrigger : Trigger<ApiTriggerConfig, Unit> {
    ...
    override val definition = adaptiveTriggerNode<ApiTriggerConfig>(
        ...
        description = "Starts the workflow when another app, a script or a shortcut asks Ottomatic to run it",
