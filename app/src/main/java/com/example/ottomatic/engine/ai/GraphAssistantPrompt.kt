 ...
 * steps, and untyped wires — Ottomatic has none of those, and each wrong assumption
...
object GraphAssistantPrompt {
    ...
    private val RULES = """
        You are editing one Ottomatic automation workflow. It is a node graph, and the user is
