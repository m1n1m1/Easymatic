...
import com.example.ottomatic.domain.model.items.MqttPublished
...
private val PublishQuality.wireValue: Int
    get() = when (this) {
        PublishQuality.AT_MOST_ONCE -> com.example.ottomatic.core.service.MqttQos.AT_MOST_ONCE
        PublishQuality.AT_LEAST_ONCE -> com.example.ottomatic.core.service.MqttQos.AT_LEAST_ONCE
        PublishQuality.EXACTLY_ONCE -> com.example.ottomatic.core.service.MqttQos.EXACTLY_ONCE
    }
