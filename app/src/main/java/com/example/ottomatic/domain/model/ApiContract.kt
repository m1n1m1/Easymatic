...
/**
 * The whole vocabulary another app speaks to Ottomatic, written down once.
 *
 ...
 * old Ottomatic from a new one *before* it discovers a method it wanted is missing.
 *
...
object ApiContract {
    ...
    const val AUTHORITY = "com.example.ottomatic.triggers"

    /** `content://com.example.ottomatic.triggers` — what a caller passes to `call()`. */
    ...
    const val ACTION_RUN = "com.example.ottomatic.action.RUN_MACRO"
     ...
     * ([com.example.ottomatic.engine.api.ApiInputs]) serving both doors.
     */
     ...
     * other is a macro sitting right there in Ottomatic that the user can turn on.
