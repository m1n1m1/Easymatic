 ...
 * [com.example.ottomatic.domain.model.schema.conversionTarget] and
 * [com.example.ottomatic.domain.model.config.ValueType.DATE_TIME].
 *
...
value class DateTime(val epochMs: Long) : Comparable<DateTime> {
    ...
    companion object {
         ...
         * [com.example.ottomatic.domain.registry.NodeSchema] use to recognise one.
         */
        const val SERIAL_NAME = "com.example.ottomatic.DateTime"
