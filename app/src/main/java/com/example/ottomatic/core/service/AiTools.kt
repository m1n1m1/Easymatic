...
data class AiParam(
     ...
     *
     * Almost always false here, and that is a fact about Ottomatic rather than a
 ...
 * leniently, config values are text everywhere in Ottomatic, and a value that arrived
 ...
 *
 * A cap on turns is [com.example.ottomatic.core.service.Ai]'s version of
