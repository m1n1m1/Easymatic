...
/**
 * The parts of a [com.example.ottomatic.domain.model.ConversationRef], already
 * parsed.
 *
 ...
 * [com.example.ottomatic.engine.ExecutionContext] without a listener sees exactly
...
object NoMessaging : Messaging {
    ...
    private const val UNAVAILABLE = "Notification access is not switched on for Ottomatic"
}
